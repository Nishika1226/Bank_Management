...
<div class="container" style=" padding-top: 0px;">
		<div class="card w-50 mx-auto my-5">
			...
			<div class="card-header text-center"><h5>User Login</h5></div>
			<div class="card-body" style="background-color: #bdbdbc;">
					...
					<div class="text-center">
						<button type="submit" class="btn btn-primary" style="background-color:#007aff;">Login</button>
						<br>
						<% 
  ...
  %>
		...
		<div class="text-center">
		<a href="register.jsp" style="color:#eef4f7;"><b>New User ? <u>Register here......</u></b></a>
		<br>
		</form>
