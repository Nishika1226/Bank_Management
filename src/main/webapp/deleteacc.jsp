		  ...
		  <form action="DeleteAc">
			...
			<div class="card-body" style="background-color: #bdbdbc;">
					...
					<div class="form-group">
						...
						<input type="text" name="del" class="form-control" placeholder="Enter acc no.">
					</div>
					
					<br>
					<div class="text-center">
						<button type="submit" class="btn btn-primary" style="background-color:#007aff;" value="" name="">Delete</button>
	               
					</div>
					<div class="text-center">
		            <span style="color: red;">*This will delete your account permanently!!</span>
		            </div>
			</div>
		</div>
		<div class="text-center">
