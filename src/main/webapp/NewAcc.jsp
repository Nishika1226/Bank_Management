...
<div class="container" style=" padding-top: 0px; margin-top: 0px">
		<div class="card w-50 mx-auto my-5">
			...
			<div class="card-header text-center"><h5>Account Registration Form </h5></div>
			...
			<div class="text-center">
				...
				<div class="form-group">
					...
					<div class="form-group">
					    ...
					    %>
						<input type="text" name="a1" class="form-control"  placeholder="" required="required" value="<%=card%>" >
					</div>
					<br>
				<div class="row g-3">
					<div class="col">
					...
					<div class="col">
						...
						<input type="text" name="a14" class="form-control" placeholder="Enter amount in Rs." required>
					</div>
					</div>
					<p>
					<div class="form-group">
					...
					<br>
					<div class="text-center">
						<input type="submit" class="btn btn-primary" style="background-color:#007aff;" value="Save and Register" name="b1">
